...
# === 2026-05-25 清理+新增 ===
WATCHLIST = {
    '002475': {'name': '立讯精密', 'buy_low': 69.00, 'buy_high': 71.50, 'stop': 68.00, 'note': '短线弱势，10日均线空头排列。支撑69（今日低点69.32），如果缩量回踩69-70可小仓试探，止损68，目标72-74。风险提示：跌破68.90则进一步看66'},
    ...
    '002698': {'name': '博实股份', 'buy_low': 14.00, 'buy_high': 15.00, 'stop': 13.50, 'note': '【已清仓2026-05-27@13.16止损】工业机器人，目标18-20，止损13.5'},
    '603876': {'name': '鼎胜新材', 'buy_low': 25.50, 'buy_high': 26.00, 'stop': 24.00, 'note': '⭐候选股，等25.5-26缩量稳住（今日量<5日均量×0.8）买，止损24，目标28-29'},
    '300623': {'name': '捷捷微电', 'buy_low': 32.00, 'buy_high': 35.00, 'stop': 30.00, 'note': '功率半导体/汽车电子，等回踩32-35买，止损30，目标45'},
}
