...
HOLDINGS = {
    ...
    '300400': {'name': '劲拓股份', 'cost': 29.40, 'stop': 31.00, 'target': 33.00, 'note': '🟢卖100股@32.01(锁利+173)，剩200股成本摊薄至29.40。止损31，目标33'},
    '300629': {'name': '新劲刚', 'cost': 26.45, 'stop': 25.50, 'target': 26.80, 'note': '⚠️成本线徘徊，五档极弱。明开观察：跌破26.00止损；稳在26.20+可等反弹26.80出；26.68巨量卖压(10800手)突破不了先出'},
}
