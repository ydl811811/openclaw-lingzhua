...
HOLDINGS = {
    ...
    '603876': {'name': '鼎胜新材', 'cost': 25.831, 'stop': 27.50, 'target': 35.00, 'note': '🔴持仓100股@25.831，跌破27.50清仓，等解套'},
    '300552': {'name': '万集科技', 'cost': 28.575, 'stop': 24.50, 'target': 32.00, 'note': '🟡持有100股@28.575，已卖100股@29.80（+4.3%），剩余等解套'},
}
