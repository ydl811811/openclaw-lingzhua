...
# ============ 已持仓监控（止损+潜在加仓区间）============
HOLDINGS = {
    '600900': {'name': '长江电力', 'cost': 27.03, 'stop': 25.00, 'target': 30.00, 'note': '🟢高股息400股@27.03，止损25，目标30'},
    '603876': {'name': '鼎胜新材', 'cost': 25.831, 'stop': 27.50, 'target': 35.00, 'note': '🔴100股@25.831，止损27.5，目标35'},
    '600845': {'name': '宝信软件', 'cost': 23.78, 'stop': 22.00, 'target': 30.00, 'note': '🟡AIDC翻倍股200股@23.78，止损22，目标30-35'},
    '300552': {'name': '万集科技', 'cost': 28.575, 'stop': 24.50, 'target': 32.00, 'note': '🟡AI基础设施200股@28.575，止损24.5，目标32'},
}
