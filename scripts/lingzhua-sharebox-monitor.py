...
class InboxMonitor:
    ...
    def __init__(self):
        # 监控路径配置（根据二哥的统一路径方案）
        # 主沟通室：claw-communication/sharebox/ 是收件箱（新消息）
        self.monitor_paths = [
            "/home/YDL/.openclaw/workspace/claw-communication/sharebox/lingzhua-box/"  # 主收件箱
        ]
    ...
    def process_changes(self, changes):
        ...
        for file_info in changes['new_files']:
            ...
            # 判断文件类型并处理
            if '龙爪' in filename or '二哥' in filename or 'longzhao' in filename or 'lingzhua' in filename:
